...
@click.option('--showjwt', default=False, help='Display the JWT for the initial create - NOTE: UNSECURE!')
def create_knox_share(username, password, knox_url, contact, comment, role, showjwt):
    database = 'none'
    table = 'none'
    qp = '?'
    if (knox_url.find('?') != -1):
    ...
    if response.status_code == 200:
        ...
        if (showjwt == True):
            print( f"JWT: {token_data.get('access_token')}")
        print("...............................................................")
